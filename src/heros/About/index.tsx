    ...
    return (
        ...
        >
            ...
            <div className="container relative z-10">
                {richText && (
                    <RichText
                        className="[&_h1]:m-0 [&_h1]:text-5xl [&_h1]:leading-[1.08] [&_h1]:font-bold [&_h1]:tracking-normal md:[&_h1]:text-display-xl [&_p]:mt-5 [&_p]:max-w-4xl [&_p]:text-body-md [&_p]:leading-7 [&_p]:font-normal [&_p]:text-paper-0 md:[&_p]:mt-16 md:[&_p]:text-body-lg md:[&_p]:leading-8"
                        data={richText}
                        enableGutter={false}
                        enableProse={false}
                    />
